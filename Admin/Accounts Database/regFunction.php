...
echo "</style>";
    ...
    <input class='input-field' type='text' onkeypress='return /[a-z keyCode-]/i.test(event.key)' placeholder='Is Disabled?(Y/N)' value='".$row['is_disabled']."' name='title' required>
  </div>
