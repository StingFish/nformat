   ...
   <tbody>
    ...
    <tr onclick="window.location='Admin/Sign In History Database/path.php';">
      <td  style="width:20%">
          ...
          <div class='imgBx' style='border:none;'>
          <img src="CvSU/blue.png" style="width:200px;"></center></td>
      <td style="width:80%;"><b>Sign In History Database</b><br><p>This is the place where you see who sign in in your system every single time. It shows the description of the accounts such as email and also the time and date of signing in.</p></td>
    </tr>
