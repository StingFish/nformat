...
.btn:hover {
  opacity: 1;
    ...
    <input class="input-field" type="file" placeholder="file" name="f1" style="outline: 1px solid black;" accept=".mp4,.png,.jpg,.avi" required>
          ...
          <div class="input-container">
    <i class="fa fa-user icon"></i>
    <input class="input-field" type="text" placeholder="Title" value="<?php echo $title;?>" name="title" required>
  </div>
          <div class="input-container">
    <i class="fa fa-user icon"></i>
    <input class="input-field" type="color" style="height: 50px" value="<?php echo $color;?>" name="color" required>
  </div>
          <div class="input-container">
    <i class="icon"></i>
