...
echo "</style>";
    ...
    <i class='fa icon'></i>
    <input class='input-field' type='file' name='f1' required>
  </div>

          <div class='input-container'>
    <i class='fa fa-user icon'></i>
    <input class='input-field' type='text' onkeypress='return /[a-z keyCode-]/i.test(event.key)' placeholder='Title' value='".$row['front_title']."' name='title' required>
  </div>
          <div class='input-container'>
    <i class='fa fa-user icon'></i>
    <input class='input-field' type='color' style='height:50px' value='".$row['color_scheme']."' name='color' required>
  </div>
