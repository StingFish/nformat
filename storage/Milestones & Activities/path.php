...
<div class="yb-php">
  ...
  $goo= 2021;
         $user_check_query = "SELECT * FROM folder where type='D' ORDER BY year";
...
if (isset($_POST['submit1'])) {
    ...
    $yr= mysqli_real_escape_string($db, $_POST['f1']);
         ...
         $user_check_query = "SELECT * FROM folder where year='$yr' AND type='D' LIMIT 1";
         $result = mysqli_query($db, $user_check_query);
    ...
    if ($user['year'] === $yr && $user['type'] === 'D') {
            ...
            $adds="INSERT INTO folder (type, year) VALUES ('D', '$yr')";
