...
<center>
  ...
  <tbody>
    <?php
          ...
          echo "<tr>";
          echo "<td data-label='Image'><center>".'<img class="image-official" src="data:image/jpeg;base64,'.base64_encode($row['image'] ).'" style="height:80px;"/>'."</center></td>";
          ...
          echo "<td data-label='Quotes'>" . $row['quotes'] . "</td>";
