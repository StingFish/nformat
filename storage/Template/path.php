...
<br>
  ...
  <div class="search-container">
    <div class="topButton">
        <button class="add-btn-reg-a add-btn-r"><i id="i"class="fas fa-user-plus"></i>Add Theme</button>
        ...
        <div class="input-icons">
          <input class="inp" type="text" placeholder="Search here..." name="search-text" id="search_text_affair">
