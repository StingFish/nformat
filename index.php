...
<header>
  ...
  <?php
    ...
    echo '<center><img src="data:image/jpeg;base64,'.base64_encode($row['twoo'] ).'" style="width:80%;margin-left:0px;border-radius:50%;"></center>';
 
  echo "<center><p style='margin-left:-10px;color:white;'>".$row['fname']." ".$row['lname']."</p></center>";
   }
  ?>
  <form action="logout.php"> 
  <center><button type="submit" style="background-color: #008CBA;height:30px;width:90%;">Log Out</button></center>
  </form>
</div>
