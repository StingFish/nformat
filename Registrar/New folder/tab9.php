...
<div id="mySidenav" class="sidenav">
  ...
  <a href="tab5.php">Corporate Officers</a>
  ...
  <a href="tab9.php" class="active">&nbsp;&nbsp;&nbsp;Senior High</a>
...
<div class="row">
        ...
        if(isset($_POST['Adds'])){
    header("Location: tab9.2.php");
}
        if(isset($_POST['search'])){
        $searchKey=$_POST['search'];
        $sql = "SELECT * from shs where lname LIKE '%$searchKey%' or fname LIKE '%$searchKey%' or mname LIKE '%$searchKey%'";
        $result = mysqli_query($db,$sql);
      }else{
        $sql = "SELECT * from shs ORDER BY year";
        $searchKey="";
      }
        $result = mysqli_query($db,$sql);
        ?>
  ...
  <div class="search-container">
    <form action="">
<button type="submit" name="Adds" class="button1" style="float: left;margin-right: 470px;background-color:#0275d8;color:white;">Add Student</button>
      ...
      <button type="button1" style="font-size: 14.5px;background-color:#0275d8;">&#128269;</button>
        ...
        <tbody>
          ...
          echo "<td style='width:40px;' align='center'>".'<img class="imahe" style="width:80px; height:100px;" src="data:image/jpeg;base64,'.base64_encode($row['image'] ).'"/>'."</td>";
          ...
          echo "<td style='width:100px;' align='center'>
                ...
                <a class='delbtn' style='text-decoration:none; color:white;' href ='registarFunction.php?edit9=".$row['id']."'>&#9998;</a>
                  </button><br><br>
                  <button class='button3' style='border:1px solid;width:90%'>
                <a class='delbtn' style='text-decoration:none; color:white;' href='registarFunction.php?email9=".$row['fname']."'>&#128465;</a>
                  </button>
                </td>";
          echo "</tr>";
}
