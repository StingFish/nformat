...
<body>
    ...
    <form action="" method="post"  enctype="multipart/form-data">
      ...
      if(isset($_POST["submit1"])){
         ...
         $user_check_query = "INSERT INTO tab10 (image, fname, mname, lname, year) VALUES ('$image', '$firstName', '$midName', '$lastName', '$year')";
         $result = mysqli_query($db, $user_check_query);
         echo "<script>alert('Added Successfully!');window.location='tabs10.php';</script>";
      }
?>
</body>
</html>