...
<div id="mySidenav" class="sidenav">
  ...
  <a href="tabs7.php" class="active">Faculty Members & Dept. Chairpersons</a><hr>
      ...
      <button type="button1" style="font-size: 14.5px;background-color:#0275d8;">&#128269;</button>
        ...
        <tbody>
          ...
          echo "<td style='width:100px;' align='center'>
                ...
                <a class='delbtn' style='text-decoration:none; color:white;' href ='registarFunctions.php?edit7=".$row['id']."'>&#9998;&nbsp;EDIT</a>
                  </button><br><br>
                  <button class='button3' style='border:1px solid;border-color:red;width:90%'>
                <a class='delbtn' style='text-decoration:none; color:white;' href='registarFunctions.php?email7=".$row['fname']."'>&#128465;&nbsp;REMOVE</a>
                  </button>                
                  </td>";
          echo "</tr>";
}
