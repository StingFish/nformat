...
<div id="mySidenav" class="sidenav">
  ...
  <a href="tab7.php" class="active">Faculty Members & Dept. Chairpersons</a><hr>
...
<div class="row">
        ...
        if(isset($_POST['Adds'])){
    header("Location: tab7.2.php");
}
        if(isset($_POST['search'])){
        $searchKey=$_POST['search'];
        $sql = "SELECT * from tab7 where lname LIKE '%$searchKey%' or fname LIKE '%$searchKey%' or mname LIKE '%$searchKey%'";
        $result = mysqli_query($db,$sql);
      }else{
        $sql = "SELECT * from tab7 ORDER BY year";
        $searchKey="";
      }
        $result = mysqli_query($db,$sql);
        ?>
      ...
      <button type="button1" style="font-size: 14.5px;background-color:#0275d8;">&#128269;</button>
        ...
        <tbody>
          ...
          echo "<td style='width:100px;' align='center'>
                ...
                <a class='delbtn' style='text-decoration:none; color:white;' href ='registarFunction.php?edit7=".$row['id']."'>&#9998;</a>
                  </button><br><br>
                  <button class='button3' style='border:1px solid;width:90%'>
                <a class='delbtn' style='text-decoration:none; color:white;' href='registarFunction.php?email7=".$row['fname']."'>&#128465;</a>
                  </button>
                </td>";
          echo "</tr>";
}
