...
<body>
    ...
    <form action="" method="post"  enctype="multipart/form-data">
      ...
      if(isset($_POST["submit1"])){
         ...
         $user_check_query = "INSERT INTO tab4 (image1, fname, mname, lname, position, year) VALUES ('$image', '$firstName', '$midName', '$lastName', '$course', '$year')";
         $result = mysqli_query($db, $user_check_query);
         echo "<script>alert('Added Successfully!');window.location='tabs4.php';</script>";
      }
?>
</body>
</html>