...
<div id="mySidenav" class="sidenav">
  ...
  <a href="tab4.php" class="active">Academic Support Officers</a>
...
<div class="row">
        ...
        if(isset($_POST['Adds'])){
    header("Location: tab4.2.php");
}
        if(isset($_POST['search'])){
        $searchKey=$_POST['search'];
        $sql = "SELECT * from tab4 where lname LIKE '%$searchKey%' or fname LIKE '%$searchKey%' or mname LIKE '%$searchKey%'";
        $result = mysqli_query($db,$sql);
      }else{
        $sql = "SELECT * from tab4 ORDER BY year";
        $searchKey="";
      }
        $result = mysqli_query($db,$sql);
        ?>
      ...
      <button type="button1" style="font-size: 14.5px;background-color:#0275d8;">&#128269;</button>
        ...
        <tbody>
          ...
          echo "<td style='width:100px;' align='center'>
                ...
                <a class='delbtn' style='text-decoration:none; color:white;' href ='registarFunction.php?edit4=".$row['id']."'>&#9998;&nbsp;EDIT</a>
                  </button><br><br>
                  <button class='button3' style='border:1px solid;border-color:red;width:90%'>
                <a class='delbtn' style='text-decoration:none; color:white;' href='registarFunction.php?email4=".$row['fname']."'>&#128465;&nbsp;REMOVE</a>
                  </button>                
                  </td>";
          echo "</tr>";
}
